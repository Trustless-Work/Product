...
impl fmt::Display for ContractError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            ContractError::ManualEscrowCannotHaveApprovalDeadline => write!(f, "Manual escrow cannot have Approval Deadline"),
            ContractError::TimeBasedEscrowRequiresApprovalDeadline => write!(f, "Time based escrow requires Approval Deadline"),
            ContractError::ApprovalNotRequiredForTimeBased => write!(f, "Approval not required for Time Based"),
            ContractError::ApprovalDeadlineCannotBeInPast => write!(f, "Approval deadline cannot be in past")
        }
    }
}
