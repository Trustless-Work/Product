...
{% content-ref url="../../introduction/developer-resources/types/payloads/update-escrow.md" %}
[update-escrow.md](../../introduction/developer-resources/types/payloads/update-escrow.md)
{% endcontent-ref %}
