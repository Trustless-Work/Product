...
{% content-ref url="../../introduction/developer-resources/types/payloads/change-milestone-status.md" %}
[change-milestone-status.md](../../introduction/developer-resources/types/payloads/change-milestone-status.md)
{% endcontent-ref %}
