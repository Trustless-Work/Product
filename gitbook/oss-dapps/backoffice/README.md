...
This tutorial will guide you through the **full** [**escrow lifecycle**](../../introduction/technology-overview/escrow-lifecycle/) using it.&#x20;

***

### **1. Prerequisite**

This is a web3 dApp, which mean you must connect a **Stellar-compatible wallet**. Learn how to get one in the [Stellar wallets section](../../introduction/stellar-and-soroban-the-backbone-of-trustless-work/stellar-wallets/).&#x20;

#### **1.2.  Tokens & Trustlines**

The Dapp currently works both on Mainnet and Testnet.&#x20;

You will need xlm, and an approved [Trustline](../../introduction/stellar-and-soroban-the-backbone-of-trustless-work/trustlines.md) to the asset you will use for this to work (for the   network you are going to use it). We limited the&#x20;
...
* Assign [**roles**](../../introduction/technology-overview/roles-in-trustless-work.md) (payer, receiver, approver, etc.).
