...
For this prototype it is expected that the dispute resolving and manual releases through our [Bakcoffice dApp](../backoffice/). We will also leverage the [escrow viewer](../escrow-viewer.md).
