...
This flow will work for any issued asset on Stellar network, you just have to point to the correct [Trustline](../../../stellar-and-soroban-the-backbone-of-trustless-work/trustlines.md). For this example we are using USDc on Stellar.&#x20;
