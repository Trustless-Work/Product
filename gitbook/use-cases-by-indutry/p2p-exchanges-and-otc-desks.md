...
Here’s how we map the transaction flow to roles in Trustless Work, you can learn more about roles [here](../introduction/technology-overview/roles-in-trustless-work.md):
